...
#define MACH_TYPE_NEWT335X	       3601
...
#ifdef CONFIG_MACH_NEWT335X
# ifdef machine_arch_type
#  undef machine_arch_type
#  define machine_arch_type     __machine_arch_type
# else
#  define machine_arch_type     MACH_TYPE_NEWT335X
# endif
# define machine_is_newt335x()        (machine_arch_type == MACH_TYPE_NEWT335X)
#else
# define machine_is_newt335x()        (0)
#endif
