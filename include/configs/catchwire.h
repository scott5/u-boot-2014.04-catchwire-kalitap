...
#ifndef __CONFIG_CATCHWIRE_H
#define __CONFIG_CATCHWIRE_H

#include <configs/catchwire_common.h>

#define MACH_TYPE_CATCHWIRE		3601	/* Until the next sync */
#define CONFIG_MACH_TYPE		MACH_TYPE_CATCHWIRE
...
#define CONFIG_SYS_LDSCRIPT		"board/wawtechnologies/catchwire/u-boot.lds"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"mmcboot=mmc dev ${mmcdev}; " \
		"if mmc rescan; then " \
			...
			"if test -n $uenvcmd; then " \
				...
				"run uenvcmd;" \
			"fi;" \
                        "echo; echo uenvcmd was not defined in uEnv.txt ...; echo trying eMMC (CatchWire) ...; echo;"\
		"fi;\0" \
	...
	"findfdt="\
                "if test $board_name = KALITAPA; then " \
